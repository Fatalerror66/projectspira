...
RANK_POINTS_DIALOG = 3899;  -- You do not need to donate any more crystals ..      
LOW_MISSION_OFFSET = 262;   -- You can consult the ..                              
MISSION_6_1_OFFSET = 4354;  -- Go to Ore Street ..                                 
...
03F0 final CS for "Fetichism" and promotion to rank 2, additional CS
03F1 final CS for "Fetichism" repeat  and promotion to rank 2, additional CS
...
if (player:getNation() == 1) then
  if fetichism_active and (trade:getItemCount() == 4) and 
    ...
    if (player:getRank() == 1) then
      ...
      player:setVar("FetichismMines",1)
    else
      if (player:getVar("FetichismMines") == 1) then
