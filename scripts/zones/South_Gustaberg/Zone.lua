...
if (rainbow == 1 and ruby == 1) then
	...
	smncs = -1; --New NPC capture needed, should be 0x385.
...
--------------------------------
-- "Smoke on the Mountain" . It appears that you cannot zone out of South Gustaberg while the sheep meat is cooking,
-- otherwise the campfire will simply give the "This fire looks perfect for cooking." message. 
