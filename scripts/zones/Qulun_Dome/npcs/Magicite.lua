...
if (player:getRank() == 4) and (mission_status >= 3) and (player:hasKeyItem(MagiciteAurastone) == 0) then
  event = Event(0x0);
  ...
  player:specialMessage(838) -- "The Magicite glows ominously"
end
end; 
...
--print("RESULT:",option);
if (csid == 0) then
  player:addKeyItem(MagiciteAurastone); 
  player:specialMessage(23,MagiciteAurastone);  
