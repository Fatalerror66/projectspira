...
-----------------------------------
--DEBUG
--player:setVar("Lycopodium_Batallia_S",1);

Lycopodium = player:getVar("Lycopodium_Batallia_S");
...
--print("count: ",count);
  ...
  if (Lycopodium == 1) then -- You have Visited the Lycopodium in Batallia_Downs[s] 
