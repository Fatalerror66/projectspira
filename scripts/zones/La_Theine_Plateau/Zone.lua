...
--Chocobo Pricing
setGlobalVar("chocoboRentPrice-LaTheine",CHOCOBO_PRICE_LA_THEINE);
setGlobalVar("chocoboRentTime-LaTheine",os.time());
setGlobalVar("chocoboFreeRent-LaTheine",0);
--print("La Theine chocobo rental reset.");
