...
elseif(csid == 0x168) then
	...
	player:setVar("lureOfTheWildcat-B-Counter",0);
	player:removeKeyItem(0x2E8);
	player:addKeyItem(0x2F2);
	player:specialMessage(KEYITEM_OBTAINED,0x2F2);
