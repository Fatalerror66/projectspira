...
--	Author: Tenjou
-- 	Goddess's Hymnus
--	Grants Reraise to party members within the area of effect.
--
--	http://wiki.ffxiclopedia.org/wiki/Goddess%27s_Hymnus
--------------------------------------
-- Includes
...
function OnSpellCast(caster,target,spell)
	...
	-- Defines
	name = EFFECT_HYMNUS; --Actually is type, but type is a keyword in LUA.
	tic = 0;
	duration = 120;
