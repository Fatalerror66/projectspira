...
--	Author: Tenjou
-- 	Sheepfoe Mambo
-- 	Increases evasion for party members within the area of effect.
--
--	http://wiki.ffxiclopedia.org/wiki/Mambo
--------------------------------------
-- Includes
...
function OnSpellCast(caster,target,spell)
	...
	-- Defines
	name = EFFECT_MAMBO; --Actually is type, but type is a keyword in LUA.
	tic = 0;
	duration = 120;
	...
	if (instrument == Gjallarhorn or (instrument == 18341 and isInDynamis(caster))) then
		power = power + 8;
	elseif (instrument == 17351 or instrument == 17849) then --Gemshorn or Hellish Bugle
		power = power + 4;
	elseif (instrument == 17370 or instrument == 17850) then --Gemshorn +1 or Hellish Bugle +1
		power = power + 8;
	end
