---------------------------
-- Tachi: Kaiten - Relic Weapon Skill
-- STR:60%
-- fTP Multipliers (100/200/300) = 3
-- Author: Kegsay
---------------------------
-- Includes
...
function onUseWeaponSkill(attacker, target, wsID)
	...
	local base = attacker:getBaseDmg() + fSTR + 
		(attacker:getStat(1) * 0.6) * alpha; --D+fSTR+WSC
	...
	--Note: After using this weaponskill you get Store TP+7. Duration varies on TP as follows:
