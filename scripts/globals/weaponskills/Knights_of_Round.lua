---------------------------
-- Knights of Round - Relic Weapon Skill
-- STR:40% / MND:40%
...
function onUseWeaponSkill(attacker, target, wsID)
	...
	local base = attacker:getBaseDmg() + fSTR + 
		(attacker:getStat(1) * 0.4 + attacker:getStat(6) * 0.4) * alpha; --D+fSTR+WSC
	...
	--Sidenote: Regen effect (10hp/tick) durations:
	--TP 100/200/300 = Duration 15/30/60 seconds
	--Normal hits have a chance of doing 2.5x normal damage. This does not apply to WSes.
