---------------------------
-- Randgrith - Relic Weapon Skill
-- STR:40% / MND:40%
-- fTP Multipliers (100/200/300) = 2.75,2.75,2.75
-- Author: Kegsay
---------------------------
-- Includes
...
function onUseWeaponSkill(attacker, target, wsID)
	...
	--Sidenote: Acc effect (+20Acc) durations:
	--TP 100/200/300 = Duration 20/40/60 seconds
	--Normal hits have a chance of doing 3x normal damage. This does not apply to WSes.
	--print("pdif: ",pdif); 
