---------------------------
-- Viper Bite - Physical One Hit Weapon Skill
-- No Mods. Deals Double Damage (Attk x2, see wiki).
...
function onUseWeaponSkill(attacker, target, wsID)
	...
	--Obtaining cRatio --Applying double attack bonus for Viper Bite.
	local double ratio = (attacker:getAtt()*2)/target:getDef();
	--Level penalty...
...
---------------------------------------------
	...
	if(attacker:getEquip(1) == DaggerofTrials and attacker:getQuestStatus(5,13) == 1 and attacker:getVar("DaggerWeaponSkillPoints") < 300 and givesEXP(target,attacker) and finaldmg > 0) then
