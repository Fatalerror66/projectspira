---------------------------
-- Dancing Edge - 5 HIT - Accuracy varies with TP
-- DEX:30% CHR:40%
-- fTP Multipliers (100/200/300) = 1.1875,1.1875,1.1875
-- Author: Kegsay
---------------------------
-- Includes
...
function onUseWeaponSkill(attacker, target, wsID)
	...
	local base = attacker:getBaseDmg() + fSTR + 
		(attacker:getStat(2) * 0.3 + attacker:getStat(7) * 0.4) * alpha; --D+fSTR+WSC
	...
	--working out hit rate for 2nd and 3rd hit
