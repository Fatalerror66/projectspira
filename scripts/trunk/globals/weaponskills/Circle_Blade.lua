---------------------------
-- Circle Blade - 1 HIT (AoE not implemented)
-- STR:35%
...
function onUseWeaponSkill(attacker, target, wsID)
	...
	ftp=1;
	--AoE Radius VS TP needs to be investigated. Currently, this attack is single target only.
	...
	--Capping cRatio (note: Circle Blade cannot critical.)
	if (ratio<0) then
	ratio = 0;
	end
	if (ratio>2) then
