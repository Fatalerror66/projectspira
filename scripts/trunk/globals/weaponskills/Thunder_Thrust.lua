---------------------------
-- Thunder Thrust - LIGHTNING Elemental MAGICAL WEAPON SKILL
--TP Mods: 1.5/2/2.5 for 100/200/300
--STR+20% INT+20%
...
function onUseWeaponSkill(attacker, target, wsID)
	...
	local damage = (attacker:getStat(1)) * 0.2 + (attacker:getStat(5)) * 0.2 + attacker:getMainLvl() + 2; --Lv+2+WSC
