...
--	Author: Tenjou
--	Jester's Operetta
-- 	Increases silence resistance for party members within the area of effect.
--
--	http://wiki.ffxiclopedia.org/wiki/Operetta
--------------------------------------
-- Includes
...
function OnSpellCast(caster,target,spell)
	...
	-- Defines
	name = EFFECT_OPERETTA; --Actually is type, but type is a keyword in LUA.
	tic = 0;
	duration = 120;
