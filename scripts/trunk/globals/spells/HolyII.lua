...
--
--
-- This spell cannot normally be used by players, so I am simply basing this off of Holy.
--------------------------------------
...
base = 1000; --Reasonable to assume this based on the other Light-element spells.
m = 3.0;
dMND = (MND - RES);
--print("dMND:",dMND);
d = base;
