...
--	Author: Tenjou
-- 	Flare II
-- 	Obtained with Merit Points.  Deals fire damage to an enemy and lowers its resistance against water.
--	
...
--Lower resistance against water.
--timer = os.time();
--flare = -60;
--flaretime = (timer + 30);
--target:setVar("Flare-ResistDown",flare);
--target:setVar("Flare-Duration",flaretime);
