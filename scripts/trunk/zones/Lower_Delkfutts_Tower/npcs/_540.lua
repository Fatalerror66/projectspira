...
if (player:getMissionStatus(2,12) == 1) and (player:getVar("mission_status") == 3) and (player:hasKeyItem(KeyitemDelkfuttKey) == 0) then
  player:specialMessage(159);
elseif (player:getMissionStatus(2,12) == 1) and (player:getVar("mission_status") == 3) and (player:hasKeyItem(KeyitemDelkfuttKey) == 1) then  
...
if (trade:getItemCount() == 1) and (trade:hasItemQty(ItemDelkfuttKey,1)) and (player:getMissionStatus(2,12) == 1) and (player:getVar("mission_status") == 3) then
  trade:isComplete();
  player:startEvent(Event(2));
else 
