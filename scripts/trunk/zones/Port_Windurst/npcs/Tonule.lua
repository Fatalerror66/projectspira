...
-----------------------------------
local event0x227 = Event(0x227);
event0x227:setParams(0xfffffffe,0xfffffffe,0xfffffffe,0xfffffffe,0xfffffffe,0xfffffffe,10,player:getCurrGil());
player:startEvent(event0x227);
end; 
