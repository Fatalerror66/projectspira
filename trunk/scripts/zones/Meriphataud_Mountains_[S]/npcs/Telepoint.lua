-----------------------------------
--	Author: Almendro,Tenjou,Trin
--  	Meriphataud Mountains[S] Telepoint
-----------------------------------



-----------------------------------
--onTrigger Action-- (Almendro)
-----------------------------------
function onTrigger(player,npc)
 
	if(player:hasKeyItem(0x3c5) ~= 1) then
		player:addKeyItem(0x3c5);
		player:specialMessage(23,0x3c5);
		--print("Key Item Obtained");
  	else
		player:specialMessage(1139);
  	end
