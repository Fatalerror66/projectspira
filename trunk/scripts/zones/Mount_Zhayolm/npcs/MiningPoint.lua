...
if (pickaxe ~= 0 and pickaxe ~= nil and playerlvl >= 25) then
	...
	--------------------	
	event0x0099 = Event(0x0099);
	event0x0099:setParams(item1,broke);
	player:startEvent(event0x0099);
