...
--	Author: Tenjou
-- 	Soni-Muni
-- 	Starts quest "The Amazin' Scorpio" (not yet implemented).  Also involved in quest "Lure of the Wildcat."  See Ibwam for designated bitmask values.
-----------------------------------
...
local wildcatc = testflag(tonumber(wildcatcount),2);
...
if (wildcat == 1 and wildcatc == false) then
	...
	player:setVar("lureOfTheWildcat-W-Counter",wildcatcount+2);
else
