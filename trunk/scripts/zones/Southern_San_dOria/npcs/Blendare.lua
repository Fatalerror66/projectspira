...
-- it is just a conditional line to say the NPC refused to accept the flyer.
	...
	if item1 == true then
		if sandyQuest16 == 1 and blendare == 0 then
			player:setVar("blendare",1)
			player:specialMessage(2129)
			player:showText(npc,0x579)
			trade:isComplete()
		elseif sandyQuest16 == 1 and blendare == 1 then
