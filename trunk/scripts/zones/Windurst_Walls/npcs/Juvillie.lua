...
-----------------------------------
local event0x196 = Event(0x196);
event0x196:setParams(0xfffffffe,0xfffffffe,0xfffffffe,0xfffffffe,0xfffffffe,0xfffffffe,10,player:getCurrGil());
player:startEvent(event0x196);
end; 
