...
if (rainbow == 1 and ruby == 1) then
	...
	smncs = -1; --New NPC Capture needed, should be 0x23. 
...
--Chocobo Pricing
setGlobalVar("chocoboRentPrice-Tahrongi",CHOCOBO_PRICE_TAHRONGI);
setGlobalVar("chocoboRentTime-Tahrongi",os.time());
setGlobalVar("chocoboFreeRent-Tahrongi",0);
--print("Tahrongi chocobo rental reset.");
--Goblin Archaeologist
setGlobalVar("archaeologist_Tah_Canyon",0)
--print("Goblin Archaeologist respawn time reset");
end;
