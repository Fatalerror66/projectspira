...
-------------------------------------------
   treasureLVL = 75;
       ...
       zoneKey = 0x427; -- 1063
-- Loot
  treasureGilArray = {0.925,9800,19180};
 treasureGemsArray = {0.075,Chrysoberyl,Moonstone,Painite,Sunstone,Jadeite,Aquamarine,Zircon};
treasureItemsArray = {0,nil};

	Map = 0x1B3;    -- 100% if not previously obtained
