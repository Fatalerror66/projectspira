---------------------------
-- Calamity - Physical One Hit Weapon Skill
-- STR:32% VIT:32% 
-- fTP Multipliers (100/200/300) = 1,1.5,4
-- Author: Kegsay
---------------------------
-- Includes
...
function onUseWeaponSkill(attacker, target, wsID)
	...
	local base = attacker:getBaseDmg() + fSTR + 
		(attacker:getStat(1) * 0.32 + attacker:getStat(3) * 0.32) * alpha; --D+fSTR+WSC
