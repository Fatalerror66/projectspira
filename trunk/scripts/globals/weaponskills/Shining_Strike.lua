---------------------------
-- Shining Strike - Light Elemental MAGICAL WEAPON SKILL
--TP Mods: 1/1.75/2.5 for 100/200/300
--STR+20% MND+20%
...
function onUseWeaponSkill(attacker, target, wsID)
	...
	local damage = (attacker:getStat(1)) * 0.2 + (attacker:getStat(6)) * 0.2 + attacker:getMainLvl() + 2; --Lv+2+WSC
