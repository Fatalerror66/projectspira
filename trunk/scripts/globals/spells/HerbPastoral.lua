...
--	Author: Tenjou
-- 	Herb Pastoral
-- 	Increases poison resistance for party members within the area of effect.
--
--	http://wiki.ffxiclopedia.org/wiki/Herb_Pastoral
--------------------------------------
-- Includes
...
function OnSpellCast(caster,target,spell)
	...
	-- Defines
	name = EFFECT_PASTORAL; --Actually is type, but type is a keyword in LUA.
	tic = 0;
	duration = 120;
