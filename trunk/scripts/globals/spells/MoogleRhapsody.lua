...
--	Author: Tenjou
--	Moogle Rhapsody
-- 	Increases confusion resistance for party members within the area of effect.
--
--	Assuming this means charm resistance.
--------------------------------------
-- Includes
...
function OnSpellCast(caster,target,spell)
	...
	-- Defines
	name = EFFECT_RHAPSODY; --Actually is type, but type is a keyword in LUA.
	tic = 0;
	duration = 120;
