...
--
--	Although WHMs can't get this spell normally, SE has apparantly permitted those with the spell to cast it!
--------------------------------------
...
base = 400; --Reasonable assumption based on Banishga I.
m = 1.5;
dMND = (MND - RES);
--print("dMND:",dMND);
d = base;
