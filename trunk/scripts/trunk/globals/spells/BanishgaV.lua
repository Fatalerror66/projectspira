...
--	Author: Tenjou
-- 	Banishga III
-- 	Deals light elemental damage to enemies within range.
--	
...
--
--
-- This spell cannot normally be used by players, so I am simply basing this off of the other Banishga spells.
--------------------------------------
...
base = 900; --Reasonable assumption based on other light-element spells.
m = 2.0;
dMND = (MND - RES);
--print("dMND:",dMND);
d = base;
