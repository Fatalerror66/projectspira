...
--
--
-- This spell cannot normally be used by players, so I am simply basing this off of the other Banish spells.
--------------------------------------
...
base = 700; --Reasonable assumption based on on other light-element spells.
m = 2.0;
dMND = (MND - RES);
--print("dMND:",dMND);
d = base;
