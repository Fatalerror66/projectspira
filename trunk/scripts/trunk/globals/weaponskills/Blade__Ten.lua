---------------------------
-- Blade: Ten - Physical One Hit Weapon Skill
-- STR:30% DEX:30% 
-- fTP Multipliers (100/200/300) = 2.5,2.75,3.0
-- Author: Kegsay
---------------------------
-- Includes
...
function onUseWeaponSkill(attacker, target, wsID)
	...
	local base = attacker:getBaseDmg() + fSTR + 
		(attacker:getStat(1) * 0.3 + attacker:getStat(2) * 0.3) * alpha; --D+fSTR+WSC
		
	--Applying fTP multiplier
	ftp = attacker:getTP()/400+2.25;
