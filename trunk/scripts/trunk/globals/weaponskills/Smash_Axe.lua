---------------------------
-- Smash Axe - Physical One Hit Weapon Skill
-- STR:30% 
...
function onUseWeaponSkill(attacker, target, wsID)
	...
	--See if it lands... assuming same chance as hit rate (95%), also assuming 100TP=1 second, with a base of 3.
	duration = 3+(attacker:getTP()/100);
	if (firsthit<=0.95) then
