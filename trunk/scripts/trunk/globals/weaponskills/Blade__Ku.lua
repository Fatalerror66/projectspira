---------------------------
-- Blade: Ku - 5 HIT - Accuracy varies with TP
-- STR:10%  DEX:10%
...
function onUseWeaponSkill(attacker, target, wsID)
	...
	local base = attacker:getBaseDmg() + fSTR + 
		(attacker:getStat(1) * 0.1 + attacker:getStat(2) * 0.1) * alpha; --D+fSTR+WSC
	...
	finaldmg = dmg * pdif;
	--print("Hit! Total Damage: ",finaldmg);
	end
	
	
	--working out hit rate for 2nd, 3rd, 4th and 5th hits
