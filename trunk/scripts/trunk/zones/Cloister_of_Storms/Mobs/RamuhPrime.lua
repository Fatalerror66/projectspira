-----------------------------------
--	Author: Tenjou
--	CELESTIAL AVATAR: Ramuh Prime
--	Fights players in the battlefield "Trial by Lightning."
--
...
function OnMobDeath(mob, killer)
	timeElapsed = os.time() - getGlobalVar("TRIAL_BY_LIGHTNING_ENTER_TIME");
	event = Event(0x7D01);
	record = getGlobalVar("TRIAL_BY_LIGHTNING_RECORD");
	if (timeElapsed < record) then
		setGlobalVar("TRIAL_BY_LIGHTNING_RECORD",timeElapsed);
	end	 
	setGlobalVar("TRIAL_BY_LIGHTNING_ENTER_TIME",0);
