...
-- initialize timers for Bastok and Sandy 6-1 fights.
setGlobalVar("Sandy_6_1_LastClear",os.time()-QM_RESET_TIME);
setGlobalVar("Bastok_6_1_LastClear",os.time()-QM_RESET_TIME);
setGlobalVar("Sandy_6_1_Fight",0);   
setGlobalVar("Bastok_6_1_Fight",0);   
end;
