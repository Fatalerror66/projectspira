...
package.loaded["scripts/zones/Pashhow/TextIDs"] = nil;
require("scripts/zones/Pashhow/TextIDs");
...
elseif (option == 2) then
	...
	if (hasOutpost(player, region) == 0) then
		...
		player:setVar("SUPPLY_QUESTS_WIN",supply_quests);
		player:setVar("supply_quest_started",0);
	end;
end
end;