...
if (rainbow == 1 and ruby == 1) then
	...
	smncs = -1; --New NPC capture needed, should be 0x68.
...
--Chocobo Pricing
setGlobalVar("chocoboRentPrice-Konschtat",CHOCOBO_PRICE_KONSCHTAT);
setGlobalVar("chocoboRentTime-Konschtat",os.time());
setGlobalVar("chocoboFreeRent-Konschtat",0);
--print("Konschtat chocobo rental reset.");
end;
