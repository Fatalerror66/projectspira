...
questItemNeeded = 0;
-- Loot
  treasureGilArray = {0.458,800,1600};
 treasureGemsArray = {0.084,Amber,Amethyst,ClearTopaz,LapisLazuli,Sardonyx,Tourmaline};
treasureItemsArray = {0.458,ShieldEarring};
-----------------------------------
-- onTrigger Action
-----------------------------------
