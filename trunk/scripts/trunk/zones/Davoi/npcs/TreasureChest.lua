...
-------------------------------------------
   treasureLVL = 44;
       ...
       zoneKey = 0x409; -- 1033
-- Loot
  treasureGilArray = {0.44,3060,6320};
 treasureGemsArray = {0.24,Ametrine,Garnet,Goshenite,LightOpal,Onyx,Peridot,Sphene,Turquoise};
treasureItemsArray = {0.32,ElectrumRing};
-----------------------------------
-- onTrigger Action
-----------------------------------
