...
-----------------------------------
local event0x264 = Event(0x264);
event0x264:setParams(0xfffffffe,0xfffffffe,0xfffffffe,0xfffffffe,0xfffffffe,0xfffffffe,10,player:getCurrGil());
player:startEvent(event0x264);
end; 
