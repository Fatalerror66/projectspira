...
-----------------------------------
local event0x32f = Event(0x32f);
event0x32f:setParams(0xfffffffe,0xfffffffe,0xfffffffe,0xfffffffe,0xfffffffe,0xfffffffe,10,player:getCurrGil());
player:startEvent(event0x32f);
end; 
